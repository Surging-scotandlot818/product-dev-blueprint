...
function readme(p: Project, frontend: ReturnType<typeof pickFrontend>, backend: ReturnType<typeof pickBackend>): string {
  return [
    ...
    ``,
    `Generated by **Product Dev Blueprint**. This scaffold is a starting point — read the bundle's PRD, architecture blueprint, engineering specification, and ADR pack first; then expand each stub.`,
    ``,
    `## Stack`,
    ``,
