...
export function Card({
  ...
  return (
    <div
      className={clsx(
        "bg-white border border-ink-200 rounded-xl shadow-sm dark:bg-ink-900 dark:border-ink-800 dark:shadow-none",
        className,
      )}
    >
      {children}
...
export function EmptyState({
  ...
  return (
    <div className="text-center py-16 px-6 border-2 border-dashed border-ink-200 dark:border-ink-800 rounded-xl bg-white dark:bg-ink-900">
      <h3 className="text-base font-semibold text-ink-900 dark:text-ink-50">{title}</h3>
      <p className="text-sm text-ink-600 dark:text-ink-400 mt-1 max-w-md mx-auto">{body}</p>
